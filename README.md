...
- **艺术家小传**：175 位艺术家的中文小传（译名、生卒、国别、身份），人物页含按时期分组的作品时间线，首页设「精选艺术家」入口。
...
| `artists.js` | 艺术家小传（`window.ARTIST_BIOS`，175 位，译名 / 生卒 / 国别 / 身份 / 中文导读） |
...
- [x] **艺术家小传**：175 位（覆盖约 63% 专辑），人物页小传卡 + 按时期分组的作品时间线，首页「精选艺术家」模块，搜索支持中文译名
